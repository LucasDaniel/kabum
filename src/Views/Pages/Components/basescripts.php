...
<!-- AdminLTE App -->
<script src="<?= $vars['libraryAdminLte'] ?>dist/js/adminlte.js?v=3.2.0"></script>
<!-- SweetAlert2 -->
<script src="<?= $vars['libraryAdminLte'] ?>plugins/sweetalert2/sweetalert2.min.js"></script>
<!-- base.js -->
<script src="<?= $vars['libraryJs'] ?>base.js"></script>